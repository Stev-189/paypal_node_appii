...
const PASS= require('./PASS'); //remplazar
...
const CLIENT = PASS.client_id;
const SECRET = PASS.client_secret;
...
const createPayment = (req, res) => {
    ...
    const body = {
        ...
        application_context: {
            brand_name: `MiTienda.com`,//nombre dle negocio
    ...
    request.post(`${PAYPAL_API}/v2/checkout/orders`, {
        auth,
        body,
        json: true // nodevulva la respuesta en un JSON
    }, (err, response) => {
